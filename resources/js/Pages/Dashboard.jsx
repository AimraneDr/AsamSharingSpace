...
import Table01 from '@/Components/tables/table-01';
import Table02 from '@/Components/tables/table-02';
        ...
        >
            ...
            >
              ...
              {/* ====== Chat Card Start  */}
                ...
                >
                    <h4
                    className="mb-6 px-7.5 text-xl font-bold text-black dark:text-white"
                    >
                    Chats
                    </h4>
                    ...
                    >
                        ...
                        <img src="../../assets/images/user/user-03.png" alt="User 03" />
                        <span
                    ...
                    >
                        <div className="relative h-14 w-14 rounded-full">
                        <img src="../../assets/images/user/user-05.png" alt="User" />
                        <span
                            className="absolute bottom-0 right-0 h-3.5 w-3.5 rounded-full border-2 border-white bg-meta-6"
                        ></span>
                        </div>
                    ...
                    >
                        ...
                        <span
                            className="absolute bottom-0 right-0 h-3.5 w-3.5 rounded-full border-2 border-white bg-meta-7"
                        ></span>
                        </div>

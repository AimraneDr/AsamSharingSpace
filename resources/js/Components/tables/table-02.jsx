  ...
  return (
    ...
    >
      <div className="px-4 py-6 md:px-6 xl:px-7.5">
        <h4 className="text-xl font-bold text-black dark:text-white">Top Products</h4>
      </div>
      ...
      >
        <div className="col-span-3 flex items-center">
          <div className="flex flex-col gap-4 sm:flex-row sm:items-center">
            <div className="h-12.5 w-15 rounded-md">
              <img src="../../assets/images/product/product-01.png" alt="Product" />
            </div>
        ...
        <div className="col-span-2 hidden items-center sm:flex">
          <p className="text-sm font-medium text-black dark:text-white">Electronics</p>
        </div>
        <div className="col-span-1 flex items-center">
      ...
      >
        <div className="col-span-3 flex items-center">
          <div className="flex flex-col gap-4 sm:flex-row sm:items-center">
            <div className="h-12.5 w-15 rounded-md">
              <img src="../../assets/images/product/product-02.png" alt="Product" />
            </div>
            <p className="text-sm font-medium text-black dark:text-white">
              Macbook Pro M1
            </p>
      ...
      >
        <div className="col-span-3 flex items-center">
          <div className="flex flex-col gap-4 sm:flex-row sm:items-center">
            <div className="h-12.5 w-15 rounded-md">
              <img src="../../assets/images/product/product-03.png" alt="Product" />
            </div>
            <p className="text-sm font-medium text-black dark:text-white">
              Dell Inspiron 15
            </p>
      ...
      >
        <div className="col-span-3 flex items-center">
          <div className="flex flex-col gap-4 sm:flex-row sm:items-center">
            <div className="h-12.5 w-15 rounded-md">
              <img src="../../assets/images/product/product-04.png" alt="Product" />
            </div>
            <p className="text-sm font-medium text-black dark:text-white">
              HP Probook 450
            </p>

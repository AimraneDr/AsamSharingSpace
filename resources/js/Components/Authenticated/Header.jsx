...
export default function Header({ sidebarToggle, toggleSidebar }) {
    ...
    const messagesOnClick = (e) => {
        e.preventDefault();
        setMessagesDropDown(!messagesDropDown);
    };

    const notificationsOnClick = (e) => {
        e.preventDefault();
    ...
    useEffect(() => {
        const handleOutsideClick = (e) => {
            // Check if click is outside the messages dropdown area
            if (
                !document
                    .getElementById("messages-dropdown-area")
                    .contains(e.target)
            ) {
                // Update messagesDropdown state and call onMessagesDropdownChange
                setMessagesDropDown(false);
            }

            // Check if click is outside the notification dropdown area
            if (
                !document
                    .getElementById("notification-dropdown-area")
                    .contains(e.target)
            ) {
                // Update notificationDropdown state and call onNotificationDropdownChange
            ...
            if (
                !document
                    .getElementById("user-dropdown-area")
                    .contains(e.target)
            ) {
    ...
    return (
        <header className=" flex bg-white  dark:bg-boxdark dark:drop-shadow-none">
                    ...
                    >
                        <div className="relative">
                            ...
                            <input
                                ...
                                className="w-full bg-transparent pl-9 pr-4 rounded-xl px-2 focus:outline-none xl:w-125"
                            />
                        </div>
                    </form>
                </div>
                ...
                <div className="flex items-center gap-3 2xsm:gap-7">
                    <ul className="flex items-center gap-2 2xsm:gap-4">
                        ...
                        >
                            ...
                            <div
                                ...
                                ${notificationsDropDown || "collapse"}`}
                            >
                        ...
                        <li id="messages-dropdown-area" className="relative">
                            <a
                                id="messages-dropdown-btn"
                                ...
                                <ul className="flex h-auto flex-col overflow-y-auto">
                                    ...
                                    <li>
                                        ...
                                        >
                                            <div className="h-12.5 w-12.5 rounded-full">
                                                <img
                                                    src="../../assets/images/user/user-04.png"
                                                    alt="User"
                                                />
                                            </div>
                    ...
                    >
                        ...
                        <div
                            ...
                            x-show="dropdownOpen"
                            className={`absolute right-0 mt-4 w-62.5 flex-col rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark

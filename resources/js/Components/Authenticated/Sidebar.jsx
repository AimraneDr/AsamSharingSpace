...
export default function Sidebar({ page, sidebarToggle, toggleSidebar }) {
    ...
    return (
        <>
            {sidebarToggle && (
                <div
                    className="absolute z-99999 w-full h-screen bg-opacity-25 bg-slate-800"
                    onClick={(e) => {
                        e.preventDefault();
                        toggleSidebar(false)
                    }}
            ...
            <aside
                className={`absolute z-999999 left-0 top-0 flex h-screen w-72.5 flex-col overflow-y-hidden gradient-v duration-150 ease-in-out dark:bg-boxdark lg:static lg:translate-x-0 ${
                    sidebarToggle || "max-lg:hidden"
                }`}
            >
                {/* <!-- SIDEBAR HEADER --> */}
                <div
                    className={`p-4 flex items-center justify-between gap-2 px-6 py-5.5 lg:py-6.5`}
                >
                    <a
                        href={route("home")}
